...
private:
	...
	std::uint32_t					palette(size_t index,std::uint8_t & out_r,std::uint8_t & out_g,std::uint8_t & out_b) const noexcept
												{
	...
	std::uint8_t					palette_grey(size_t index) const noexcept
												{
